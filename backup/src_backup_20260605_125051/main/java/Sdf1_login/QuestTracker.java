...
// 主世界结构归类
    ...
    static {
        ...
        CATEGORY_KEYWORDS.put("要塞", "地下");
        CATEGORY_KEYWORDS.put("远古城市", "地下");
    ...
    private String detectStructureAt(
        ...
        try {
            ...
            // 使用 BlockPosition 提高性能
            io.papermc.paper.math.Position pos =
            ...
            for (Structure structure : Registry.STRUCTURE) {
                if (w.hasStructureAt(pos, structure)) {
                    // 获取结构 NamespacedKey（如 minecraft:village）
                    NamespacedKey structureKey = Registry.STRUCTURE.getKey(structure);
                    String keyStr = (structureKey != null) ? structureKey.toString() : "unknown";
                    String cat =
    ...
    private String mapStructureCategory(
        ...
        if (structureName.contains("下界要塞"))
            return "下界";
        if (structureName.contains("猪灵堡垒"))
            return "下界";
        if (structureName.contains("玄武岩结构"))
            return "下界";
