...
| 前置插件 | 选装类型 |  功能作用 |
| :--- | :--- | :--- |
| [CY_beibao](https://github.com/ypsdf1/CY_beibao) | 可选,推荐 | 云背包，积分商城可购买背包容量
...
## 4. 下载地址
- GitHub Release：[https://github.com/ypsdf1/sdf1_login/releases](https://github.com/ypsdf1/sdf1_login/releases) (推荐)
- 官方仓库：[https://git.ypshidifu.cn/youpaishidifu/Sdf1_login](https://git.ypshidifu.cn/youpaishidifu/Sdf1_login)
