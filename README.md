...
#### 2.2.2.1 消息.txt
此文件控制着整个插件的所有提示消息，您可以根据自己的需求修改，修改后需要执行 /sdf1_login reload 重载插件。支持[颜色代码](https://zh.minecraft.wiki/w/%E6%A0%BC%E5%BC%8F%E5%8C%96%E4%BB%A3%E7%A0%81)
同时兼容`<b> </b>`标签，对段落加粗，`\n 和 <br>`进行段落换行
...
chat_url_admin_notify=§e§l[Sdf1_chat] §f{player} 发���违规链接: {url} (第{count}次)
